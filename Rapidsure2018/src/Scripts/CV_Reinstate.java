...
public class CV_Reinstate {
    ...
    public void test(@Optional("1") int iterationNumber) throws InterruptedException, Exception {
        ...
        Report report = new Report(REPORT_PATH, "reinstate");
...
//        *******************Clicks on Request Reinstate*******************
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getObjectProperty("requestReinstateLink")))).click();
        System.out.println("clicked on Request Reinstate");
...
//       ******************Getting Policy details from Summary Page*******************
        ...
        System.out.println("Reinstate_Status=" + policy_Status);
...
//      *********************Reporting************************
        ...
        report.addResult("Reinstate_Status", policy_Status);
