...
/**
 * Created by agarwalp on 7/13/2017.
 */
public class CV_Renewal {
    ...
    public void test(@Optional("1") int iterationNumber) throws InterruptedException, Exception {
        InputData inputData = new InputData(INPUT_DATA_PATH, "CV_Renewal", iterationNumber);
        ...
        Report report = new Report(REPORT_PATH, "renew");
...
//       *******************Clicks on Renew*******************
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getObjectProperty("renewLink")))).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(OR.getObjectProperty("renewCheckPopUp"))));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath(OR.getObjectProperty("okButton")))).click();
        System.out.println("Renew OK button clicked***********");
...
//       ******************Getting Policy details from Summary Page*******************
        ...
        System.out.println("Renew_Status=" + policy_Status);
...
//      *********************Reporting************************
        ...
        report.addResult("Renew_Status", policy_Status);
