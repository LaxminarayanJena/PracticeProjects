...
public class ReportWriter {
    ...
    public synchronized void updateReportFile(String reportPath, HashMap<String, String> resultMap) {
        try {
            ...
            accountNumberRow.createCell(4).setCellValue("PDF Validation");
            accountNumberRow.createCell(5).setCellValue("Status");
            accountNumberRow.createCell(6).setCellValue("Remark");
            ...
            policyNumberRow.createCell(4).setCellValue("Validation for Account Number");
            policyNumberRow.createCell(5).setCellValue(resultMap.get("Result")); 
            ...
            policyAmountRow.createCell(4).setCellValue("Validation for Policy Number");
            policyAmountRow.createCell(5).setCellValue(resultMap.get("Result")); 
            ...
            premiumMatchStatus.createCell(4).setCellValue("Validation for Billing date");
            premiumMatchStatus.createCell(5).setCellValue(resultMap.get("Result")); 
            
            
            Row ValidationforPremium = newSheet.createRow(4);
            ValidationforPremium.createCell(4).setCellValue("Validation for Premium");
            ValidationforPremium.createCell(5).setCellValue(resultMap.get("Result")); 
            ValidationforPremium.createCell(6).setCellValue(resultMap.get("ValidationMessage")); 
