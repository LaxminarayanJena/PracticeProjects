...
require_all File.join(Support::Paths.discovery_root, "pages")
Graphql = PageHelpers::Graphql.new
...
require_relative "../../../../screens/eurosports_black_screens/eurosports_black_android_screens/base_screen"
require_all File.join(File.dirname(__FILE__), "../../../../screens/screen_helpers/")
require_all File.join(File.dirname(__FILE__), "../../../../screens/eurosports_black_screens/eurosports_black_android_screens")
