...
ENV["platformType"] = "native"
ENV["platformName"] = "Android" unless ENV["platformName"]
...
require_relative "../../../screens/native_screens/base_screen"
require_all File.join(File.dirname(__FILE__), "../../../screens/screen_helpers/")
require_all File.join(File.dirname(__FILE__), "../../../screens/native_screens")
