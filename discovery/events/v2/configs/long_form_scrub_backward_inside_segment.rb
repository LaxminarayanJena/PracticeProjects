SCRUB_BACK_INSIDE_SEGMENT = [{ type: "session", payload_action: "start",
...
VERIFYCOUNT_LF_SCRUB_BACKWARD_INSIDE = [%i[session_start session_stop], %i[playback_start playback_stream_initiate],
