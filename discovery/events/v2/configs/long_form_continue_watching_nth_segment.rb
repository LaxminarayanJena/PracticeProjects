LF_CONTINUE_WATCHING_NTH_SEGMENT = [{ type: "session", payload_action: "start",
                                    ...
                                    { type: "playback", payload_action: "seekstop",
                                      next_seq: [{ type: "playback", payload_action: "resume" },
                                                 { type: "playback", payload_action: "complete" }] },
                                    { type: "playback", payload_action: "complete",
                                      next_seq: [{ type: "playback", payload_action: "streamComplete" }] }].freeze

VERIFYCOUNT_LF_CONT_WATCH_NTH_SEG = [%i[session_start session_stop], %i[playback_start playback_stream_initiate],
                                     %i[playback_start playback_stop], %i[ad_break_start ad_break_complete], %i[ad_start ad_complete],
                                     %i[ad_start sum_of_num_ads], %i[playback_resume ad_break_complete],
                                     %i[chapter_start mod_chapter_complete], %i[ad_buffer_start ad_buffer_stop],
