LF_AD_CLICKED_PAUSE_PLAY = [{ type: "session", payload_action: "start",
                            ...
                            { type: "playback", payload_action: "seekStop",
                              next_seq: [{ type: "playback", payload_action: "resume" },
                                         { type: "playback", payload_action: "complete" }] },
                            { type: "playback", payload_action: "complete",
                              next_seq: [{ type: "playback", payload_action: "streamComplete" }] },
                            { type: "ad", payload_action: "pauseStart",
                              next_seq: [{ type: "ad", payload_action: "pauseStop" },
                                         { type: "ad", payload_action: "progress" }] },
                            { type: "ad", payload_action: "pauseStop",
                              next_seq: [{ type: "ad", payload_action: "resume" }] },
                            { type: "ad", payload_action: "resume",
                              next_seq: [{ type: "ad", payload_action: "progress" }] }].freeze

VERIFYCOUNT_AD_PAUSE_PLAY = [%i[session_start session_stop], %i[ad_break_start ad_break_complete], %i[ad_start ad_complete],
                             %i[ad_start sum_of_num_ads], %i[playback_resume ad_break_complete], %i[playback_seekStart playback_seekStop],
                             %i[playback_start playback_stream_initiate], %(ad_pauseStart ad_resume),
                             %i[ad_pauseStart ad_pauseStop], %i[ad_buffer_start ad_buffer_stop],
