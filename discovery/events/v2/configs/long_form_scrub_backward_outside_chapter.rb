LF_SCRUB_BACKWARD = [{ type: "session", payload_action: "start",
                     ...
                     { type: "ad", payload_action: "pauseStart",
                       next_seq: [{ type: "ad", payload_action: "pauseStop" },
                                  { type: "ad", payload_action: "progress" }] },
                     { type: "ad", payload_action: "pauseStop",
                       next_seq: [{ type: "ad", payload_action: "resume" }] }].freeze

VERIFYCOUNT_LF_SCRUB_BACK_OUTSIDE = [%i[session_start session_stop], %i[ad_break_start ad_break_complete],
