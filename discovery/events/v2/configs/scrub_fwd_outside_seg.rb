LF_SCRUB_FORWARD = [{ type: "session", payload_action: "start",
...
VERIFYCOUNT_LF_SCRUB_FORWARD_OUTSIDE = [%i[session_start session_stop], %i[ad_break_start ad_break_complete],
                                        %i[ad_start ad_complete], %i[ad_start sum_of_num_ads], %i[playback_seekStart playback_seekStop],
                                        %i[playback_resume sum_adBreakcomplete_playbackseekStart],
                                        %i[playback_start playback_stream_initiate], %i[ad_buffer_start ad_buffer_stop],
