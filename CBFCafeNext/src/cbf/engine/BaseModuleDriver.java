/******************************************************************************
$Id : BaseModuleDriver.java 3/3/2016 7:07:21 PM
...
/**
 * 
 * Implements ModuleDriver interface to map input data row with component and invoke component
 * 
 */
public class BaseModuleDriver implements ModuleDriver {
	...
	/**
	 * Performs mapping of component with DataRow
	 * 
	 * @param componentCode
	...
	private void invokeMethod(Method m, String componentCode, DataRow input,
		...
		try {
			...
			logger.handleError("Failed in executing component ", componentCode, " ", e.getTargetException().getMessage());
		}
	}
}
