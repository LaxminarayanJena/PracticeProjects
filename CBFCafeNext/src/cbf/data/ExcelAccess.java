/******************************************************************************
$Id : ExcelAccess.java 3/3/2016 7:07:19 PM
...
/**
 * Implementation of DataAccess interface to read the excel data file and the
 * component specific data rows
 * 
 */
public class ExcelAccess implements DataAccess {
	...
	/**
	 * 
	 * Constructor to initialize data related parameters
	 * 
	 * @param params
	...
	/**
	 * Returns row data for the selected rows of a component
	 * 
	 * @param moduleCode
	 ...
	 * @param rowSelector
	 *            contains row selection id
	 * @return list of Map of selected rows for specified component
	 */
