/******************************************************************************
$Id : Harness.java 3/3/2016 7:07:22 PM
...
/**
 * 
 * Main class to make the calls to laod configurations, initializing the
 * resource paths(auto home, work home and run home), reporters and loading the
 * engine
 * 
 */
public class Harness {
	 ...
	 * 
	 * @param runMap
	 *            map of run time configuration arguments
	 * @param runName
	 *            sheet name containing the test case instances
	 * 
	 * 
	 */
	...
	private void initializeLogs(String resultsFolder) {
		...
		logger.initialize(ResourcePaths.getInstance().getFrameworkResource(
	...
	private void initializeResourcePaths() {
		...
		try {
			...
			autoHome=workHome+"//Projects//SeleniumProject";
			runHome=workHome+"//Logs//ExecutedOn_"+UniqueUtils.uniqueDate();
		} catch (Exception e) {
			System.out
					.println("Please check the config files for workHome, autoHome and runHome");
		}
