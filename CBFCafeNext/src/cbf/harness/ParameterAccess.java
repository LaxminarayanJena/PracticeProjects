/******************************************************************************
$Id : ParameterAccess.java 3/3/2016 7:07:23 PM
...
public class ParameterAccess implements TestResultTracker.Observer {
	...
	public String get(String targetName) {
		return (String) variables.get(0).get(targetName);
			}
	 ...
	 * @return entity object
	 */
	public void put(String targetName, String value) {
		variables.get(0).put(targetName, value);
	}
