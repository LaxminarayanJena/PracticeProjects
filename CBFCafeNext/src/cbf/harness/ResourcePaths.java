/******************************************************************************
$Id : ResourcePaths.java 3/3/2016 7:07:23 PM
...
public class ResourcePaths {
	...
	public String getRunResourceJXML(String relPath, String relName) {
		String[] rumhomedummy  = runHome.split("//");
		return createPath(Paths.get(rumhomedummy[0],rumhomedummy[1]).toString(), relPath, relName);
	}
	...
	private String createPath1(String home, String relPath, String relName) {
		if (!relPath.equals(""))
			home = home + "//" + relPath;
		if (!relName.equals(""))
			home = home + "//" + relName;
