...
*/
public class US1208_AccountDocumentsDriver extends BaseWebModuleDriver {
	private ParameterAccess paramAccess;
	
	public US1208_AccountDocumentsDriver(ParameterAccess paramAccess) {
	...
	public void US1208_VerifyDocument(DataRow input, DataRow output) {
		...
		//5. Click on DownloadDocument button
